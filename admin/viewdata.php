...
$columnnames = array();
	...
	<tr class="datath"><th class="datath"><?php
	...
	<?php
		...
		{?>
			...
			<td class="datatd"><a href = "<?php
			echo "delete.php?primarykey=".$row["$primaryfield"]."&primaryfield=$primaryfield&table=$table";?> " onClick="return confirm('Are you sure?');">Delete</a></td></tr>
		<?php
		}	
		?>
		</table>
		...
		</td></tr><a style="margin-left: 5px;" href="<?php echo "downloadcsv.php?"."&table=$table";?>" " onClick="return confirm('Are you sure you want to download the file?');"><img src="csv.jpg" /></a> &nbsp; &nbsp;
